...
obj2 = text(750,1000,txt_player1name, 'fontsize',22,'Color','w' ,'HorizontalAlignment', 'center');
...
obj3 = text(2750,1000,txt_player2name, 'fontsize',22,'Color','w','HorizontalAlignment', 'center');

delete(obj1);

% Assigins players their objects
txt_instructions = [ Name1 , ' type your item: rock, paper, or scissors'];
obj1 =  text(1750,2300,txt_instructions, 'fontsize',15,'Color','w','HorizontalAlignment', 'center');
